...
- 生成时间: `2026-06-12T11:58:32.818174+00:00`
...
| --- | --- | --- | ---: | ---: | ---: | ---: | --- | --- | ---: | ---: | --- | --- |
| 真实/生成鲁棒初筛 | 两层可信输出的第一层，适合作为低误报初筛组件。 | `b7116c73-4bcb-4afa-8d9e-f6b42cf15130` | 40 | 0.615 | 0.979 | 0.979 | 0.957/0.917/0.936 | 0.882/0.938/0.909 | 0.319 | 0.200 | 未达标 | Source Real FPR=0.200 未达到 <= 0.100 的验收门槛。 |
| GPT-image2 专项识别 | 第二层来源线索组件，只输出疑似 GPT-image2，不做执法定论。 | `a0c1c021-462c-4e38-9567-27737aca6694` | 40 | 0.639 | 0.996 | 0.987 | 0.857/1.000/0.923 | 1.000/0.750/0.857 | 0.325 | 0.400 | 未达标 | Source Macro-F1=0.325 未达到 >= 0.450 的验收门槛。 |
...
- Candidate: `b7116c73-4bcb-4afa-8d9e-f6b42cf15130`
...
- Candidate: `a0c1c021-462c-4e38-9567-27737aca6694`
...
- 验收状态: `needs_improvement`；建议: `needs_more_cross_source_gpt_image2`；问题: Source Macro-F1=0.325 未达到 >= 0.450 的验收门槛。
- Clean accuracy / Macro-F1 / Macro OvR AUC: `0.850` / `0.639` / `0.994`
- Positive label / positive AUC: `gpt-image2` / `0.996`
- Binary Macro-F1 / binary AUC / generated recall / real FPR: `0.593` / `0.987` / `1.000` / `0.250`
- Source-holdout Macro-F1 / binary Macro-F1 / generated recall / real FPR: `0.325` / `0.374` / `0.735` / `0.400`
- Label-covered Macro-F1 / binary Macro-F1 / real FPR: `0.417` / `0.390` / `0.333`
- Label distribution: `{"gpt-image2": 8, "other-generated": 16, "real": 16}`
- Prediction distribution: `{"gpt-image2": 6, "other-generated": 22, "real": 12}`

| 验收项 | 当前值 | 门槛 | 状态 |
| --- | ---: | --- | --- |
| GPT-image2 Recall | 0.750 | >= 0.600 | 达标 |
| GPT-image2 Precision | 1.000 | >= 0.700 | 达标 |
| Source Macro-F1 | 0.325 | >= 0.450 | 未达标 |

| Clean class | Precision | Recall | F1 | Support |
| --- | ---: | ---: | ---: | ---: |
| gpt-image2 | 1.000 | 0.750 | 0.857 | 8 |
| other-generated | 0.727 | 1.000 | 0.842 | 16 |
| real | 1.000 | 0.750 | 0.857 | 16 |
| unknown | 0.000 | 0.000 | 0.000 | 0 |
